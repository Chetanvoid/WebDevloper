  ...
  const onSubmitHandler =()=>{
    ...
    let getFormValidationDetails = getFormValidation;
      ...
      for(let obj in getFormValidationDetails){
        ...
        else if(getFormValidationDetails[obj]['pattern'] &&  
    ...
    <div id="main">
      <div className="container">
        Name:<input type="text" onChange={onChangeHandler} name="name" data-testid="name"/>
         {getSubmit && getFormValidation['name']['status'] && 
         getFormValidation['name']['status']!=='complete' 
         && <div className="danger">
           { getFormValidation['name']['status']==="required"? getFormValidation['name']['requiredError']
           :getFormValidation['name']['patternMessage']}
          </div> } 
          

        Email Address:<input type="text" onChange={onChangeHandler} name="email"  data-testid ="email"/>
        {getSubmit && getFormValidation['email']['status'] && 
         getFormValidation['email']['status']!=='complete'
         && <div className="danger">
           { getFormValidation['email']['status']==="required"? getFormValidation['email']['requiredError']
           :getFormValidation['email']['patternMessage']}
          </div> }
        ...
        {getSubmit && getFormValidation['phoneNumber']['status'] && 
        getFormValidation['phoneNumber']['status']!=='complete' &&  
        <div className="danger">
           { getFormValidation['phoneNumber']['status']==="required"?
            getFormValidation['phoneNumber']['requiredError']
            :getFormValidation['phoneNumber']['patternMessage']}
          </div> } 


        Password:<input type="password" onChange={onChangeHandler} name="password" data-testid ="password"/>
        {getSubmit && getFormValidation['password']['status'] &&
         getFormValidation['password']['status']!=='complete' &&
          <div className="danger">
           { getFormValidation['password']['status']==="required"? 
           getFormValidation['password']['requiredError']:
           getFormValidation['password']['patternMessage']}
          </div> } 
