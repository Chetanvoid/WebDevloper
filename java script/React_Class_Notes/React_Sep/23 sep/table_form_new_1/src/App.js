...
function App() {
  ...
  return (
    <div className="App">
      ...
      <Form title={getEditObject.title} amount={getEditObject.amount} duration={getEditObject.duration}   
      getEditStatus={getEditStatus}  onChangeHandler={onChangeHandler} 
      onEditFinalSubmitHandler={onEditFinalSubmitHandler} 
      onEditInitialHandler={onEditInitialHandler}  onSubmitHandler={onSubmitHandler}/>

      <Table onEditInitialHandler={onEditInitialHandler} onDeleteHandler={onDeleteHandler} 
      getFlag={getFlag} getList={getList}/>
