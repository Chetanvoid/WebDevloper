...
import {alphaNumericValidation,emailValidation,
    passwordValidation,bioValidation,telephoneValidation} 
    ...
    if( getForm.password!="" && getForm.confirm!="" && getForm.password === getForm.confirm){
     ...
     return (<div>
        ...
        <div className="form-group">
           ...
           {getGlobal && getFormValidation.firstName && <div className="danger">
            First Name must be alphanumeric and contain 3 - 16 characters</div>} 
        </div>
        ...
        <div className="form-group">
            ...
            {getGlobal && getFormValidation.lastName && <div className="danger">
              Last Name must be alphanumeric and contain 3 - 16 characters</div>}
        </div>
        ...
        <div className="form-group">
            ...
            {getGlobal && getFormValidation.email && <div className="danger">
              Email must be valid address,e.g:akash@gamil.com</div>}
        </div>
        ...
        <div className="form-group">
            ...
            {getGlobal && getFormValidation.password && <div className="danger">
              Password must be alphanumeric(@,_and - are also allowed) and between 6-20 characters</div>}
        </div>
        ...
        <div className="form-group">
            ...
            {getGlobal && getFormValidation.confirm && <div className="danger">
              Password must be alphanumeric(@,_and - are also allowed) and between 6-20 characters</div>}
        </div>
        ...
        <div className="form-group">
            ...
            {getGlobal && getFormValidation.telephone && <div className="danger">
              A valid telphone number (11 digits and 333-333-3333)</div>} 
        </div>
        ...
        <div className="form-group">
            ...
            {getGlobal && getFormValidation.bio && <div className="danger">
              Bio must contain only lowercase letters,underscores,hyphens and be 8-50 characters</div>}
        </div>
